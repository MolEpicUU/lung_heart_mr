...
Note that at least six observations with the highest values of Cook's D are marked in the plot, 
no matter if they exceed the calculated cutoff for being influential or not. For details regarding **Cook's D**, check the section 
...
A comparison with plink results cannot be shown because no summary statistics file was invoked.
...
Links to databases cannot be shown because the position of the marker is not available. Marker
positions are only available if a summary statistics file has been invoked.
